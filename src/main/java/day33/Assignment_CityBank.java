...
public class Assignment_CityBank {

    public static void main(String[] args) throws InterruptedException, IOException, IOException {

        System.setProperty("webdriver.chrome.driver", "/home/anita/workspace/seleniumproject/C:/Drivers/chromedriver_win32/chromedriver.exe");
        ...
        String path="/home/anita/workspace/seleniumproject/testdata/caldata2.xlsx";   // giving path to file to start reading
        ExcelUtils XLUtils;
        ...
        for(int i=1;i<=rows;i++)
        {
            ...
            List<WebElement> opts=driver.findElements(By.xpath("//div[@id='mat-select-0-panel']//mat-option"));
